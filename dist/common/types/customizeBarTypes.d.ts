...
export interface CalculationConfiguration {
    ...
    calculate: (selectedMetadataKeyValue: MetadataKeyValue | null, metadata: MetaData, trends: Trend[], allCountersConfigurations: CountersConfigurations, allItemsCount: number) => {
