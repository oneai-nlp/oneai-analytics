(() => {
  ...
  (__webpack_require__.m = __webpack_modules__),
    ...
    (__webpack_require__.u = (chunkId) =>
      (({
        487: 'OneAIAnalyticsApiWrapperExample-stories',
        668: 'OneAIAnalyticsUploadExample-stories',
        870: 'OneAIAnalyticsStaticExample-stories',
      }[chunkId] || chunkId) +
      '.' +
      {
        18: '6414853c',
    ...
    (__webpack_require__.l = (url, done, key, chunkId) => {
      if (inProgress[url]) inProgress[url].push(done);
        ...
        if (void 0 !== key)
          for (
            ...
            if (
              ...
              s.getAttribute('data-webpack') == 'oneai-analytics:' + key
            ) {
              script = s;
              break;
            }
        ...
        script ||
          ...
          script.setAttribute('data-webpack', 'oneai-analytics:' + key),
          (script.src = url)),
          (inProgress[url] = [done]);
    ...
    (() => {
      ...
      var webpackJsonpCallback = (parentChunkLoadingFunction, data) => {
        ...
        chunkLoadingGlobal = (self.webpackChunkoneai_analytics =
          self.webpackChunkoneai_analytics || []);
